...
public class DiverTest {
    ...
    public void testLegalMoves() {
        ...
        Turn turns = Turn.createInitialTurn(Difficulty.NORMAL, Arrays.asList(new Pair<>(PlayerType.DIVER, false), new Pair<>(PlayerType.COURIER, false)), this.testMapNull);
        Player diverb = turns.getPlayers().get(0);
        Player courierb = turns.getPlayers().get(1);
