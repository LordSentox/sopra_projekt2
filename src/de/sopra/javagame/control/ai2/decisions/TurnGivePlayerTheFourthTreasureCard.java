...
public class TurnGivePlayerTheFourthTreasureCard extends Decision {
    ...
    public Decision decide() {
        ...
        for (Player player : allPlayers) {
            ...
            if (any(
                    all(air > ZERO_CARDS, air2 == THREE_CARDS),
                    all(earth > ZERO_CARDS, earth2 == THREE_CARDS),
                    all(fire > ZERO_CARDS, fire2 == THREE_CARDS),
                    all(water > ZERO_CARDS, water2 == THREE_CARDS)
            )) {
                return this;
            }
        }
